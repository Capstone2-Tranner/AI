...
RAW_DATA_SPLIT_PATH = CURRENT_DIR.parent / "raw_data_split" / "raw_data_split.py"
STORE_VECTOR_PATH = CURRENT_DIR.parent / "store_vector" / "store_vector.py"

# raw_data_split.py에서 S3 클래스 import
sys.path.append(str(RAW_DATA_SPLIT_PATH.parent))
